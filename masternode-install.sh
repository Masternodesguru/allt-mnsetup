...
COIN_TGZP='https://github.com/masternodeguru/allt-mnsetup/releases/download/1003/allt1003linux.zip'
COIN_BOOTSTRAP=''
...
echo -e "alias piggieinfo='/root/allt-general-info'" >> /root/.bashrc
...
function important_information() {
 ...
 echo -e "You can also use ${RED}allt-cli getinfo${NC}, ${RED}allt-cli getnetworkinfo${NC}, ${RED}allt-cli getconnectioncount${NC}commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
