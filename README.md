...
1. ALLT for Collateral <br>
(You can buy ALLT from exchange for collateral) <br>

GRAVIEX: https://graviex.net/markets/alltbtc

2. Download your Local Wallet: https://github.com/Masternodesguru/allt/releases/download/1003/allt1003linux.zip
...
1. After you login on your VPS , with this command you will download masternode-installer.   
 
- dl the install script 
`wget https://raw.githubusercontent.com/masternodesguru/allt-mnsetup/master/masternode-install.sh` 
